...
class BlackJack:
    ...
    def pressedStay(self):      # 수정 o
        while self.dealer.value() < 17:            # 딜러의 카드가 13보다 작거나 같다면 딜러 hit
            self.nCardsDealer += 1
